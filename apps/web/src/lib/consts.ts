...
export const PRICING_TIERS = [
    ...
    { photos: 1000,  monthly: 500.00,  perPhoto: 0.50, yearlyMonthly: 440.00,  yearlyPerPhoto: 0.44, tier: "Professional", features: ["Unused credits roll over", "Auto TV Blackout", "Auto Add Fire"] },
 ...
 * - Free:       photos === 0
 * - Pro:        photos > 0 && photos <= 1000 (Basic / Standard / Professional)
