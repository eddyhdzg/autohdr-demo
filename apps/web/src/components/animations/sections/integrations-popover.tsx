        ...
        <AnimatePresence>
            {open && (
                <motion.div
                    ...
                    className={`absolute ${positionClasses} left-1/2 -translate-x-1/2 md:left-4 md:translate-x-0 overflow-hidden rounded-none w-[280px] md:w-[350px] bg-linear-to-b from-[#E5E7EB] dark:from-[#27272A] to-[#E5E7EB]/40 dark:to-[#27272A]/40 text-secondary-foreground text-sm font-medium backdrop-blur-xl backdrop-saturate-150 z-50`}
                >
